		...
		<div class="container">
			...
			<ul class="header-links pull-right">
			   <c:choose>
			      ...
			      <c:otherwise>
			         <li><a href="/member/${loginMember.m_no}"><i class="fa fa-user-o"></i>Edit</a></li>
			         <li><a href="/logout"><i class="fa fa-sign-out"></i>Logout</a></li>
			     	 <li><a href="javascript:deleteMember(${loginMember.m_no});"><i class="fa fa-trash"></i>Delete</a></li>
			      </c:otherwise>
			   </c:choose>
			</ul>
		</div>
