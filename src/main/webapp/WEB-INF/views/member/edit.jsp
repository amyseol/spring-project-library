						...
						<div class="billing-details">
							...
							<form id="editFrm" name="edit_member_form" >
								...
								<div class="form-group">
									<input class="input" type="text" name="m_id" value="${loginMember.m_id}" readonly disabled>
								</div>
								<div class="form-group">
									<input class="input" type="text" name="m_name" value="${loginMember.m_name}">
								</div>
								<div class="form-group">
									<input class="input" type="text" name="m_mail" value="${loginMember.m_mail}">
								</div>
